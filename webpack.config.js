...
const _PROJECT_TITLE_ = 'DictionaryApp';
...
module.exports = {
    entry: [
        './AppBrowser/Index.jsx',
        //'webpack-dev-server/client?http://localhost:3000',
    ],
    output: {
        // libraryTarget: "amd",
        path: __dirname + '/AppBrowserBuild/',
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            template: __dirname + '/AppBrowser/Templates/Index.html',
            //favicon: __dirname + '/AppBrowser/Templates/favicon.ico',
            filename: 'index.html',
        }),
        new CleanWebpackPlugin(['AppBrowserBuild'], {
            root: __dirname,
            verbose: true,
            dry: false
        }),
